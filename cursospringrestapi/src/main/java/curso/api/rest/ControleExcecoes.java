...
public class ControleExcecoes extends ResponseEntityExceptionHandler { 
	...
	private static final String ObjectError = null;
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if (ex instanceof MethodArgumentNotValidException) { /*Para todos as ex do tipo argumento invalido.*/
	...
	protected ResponseEntity<Object> handleExcpetionDataIntegry(Exception ex){
    	...
    	objetoError.setCode(HttpStatus.INTERNAL_SERVER_ERROR + "==>" + HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase()); /*Geralmente sempre erro interno do servidor*/
