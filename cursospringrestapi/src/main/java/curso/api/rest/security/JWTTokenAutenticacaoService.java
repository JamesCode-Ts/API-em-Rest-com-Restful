...
public class JWTTokenAutenticacaoService {
	...
	public void addAuthentication(HttpServletResponse response , String username) throws IOException {
        ...
        .getBean(UsuarioRepository.class).atualizaTokenUser(token, username);
	...
	public Authentication getAuhentication(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			try {
				 response.getOutputStream().println("Seu Token esta ixpirado, faca o login ou informe outro TOKEN para identificacao");
