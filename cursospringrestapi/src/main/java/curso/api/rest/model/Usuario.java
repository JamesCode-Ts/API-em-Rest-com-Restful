...
public class Usuario implements  UserDetails {
	...
	/*A interface UserDetaills é especifica para detalhes de usuario para autentificação*/
	@Id
   ...
   /*Mapeamento, criou a tabela no banco de dados com os papeis conectados*/
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, login, nome, roles, senha, telefones);
	}
